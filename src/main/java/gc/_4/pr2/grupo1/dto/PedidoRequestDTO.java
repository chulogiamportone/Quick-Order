...
public class PedidoRequestDTO {
    ...
    public IdDTO getEmpleado() {
        return empleado;
    }

    public void setEmpleado(IdDTO empleado) {
        this.empleado = empleado;
    }

    public List<IdDTO> getLista_Productos() {
        return Lista_Productos;
    }

    public void setLista_Productos(List<IdDTO> lista_Productos) {
        Lista_Productos = lista_Productos;
    }

    public List<IdDTO> getLista_Mesas() {
        return Lista_Mesas;
    }

    public void setLista_Mesas(List<IdDTO> lista_Mesas) {
